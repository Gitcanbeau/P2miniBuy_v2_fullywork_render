...
const YourOrdersScreen = () => {
	...
	//return a ? b : c
	//return a ? (<div> <div/>) : (<div> <div/>)
	//either direct put the content or cover the <div> within parenthesis
	//return a ? (<div> { b } <div/>) : (<div> <div/>)
	// content in wrapper div should be covered by curly braces
	return userInfo ? (
		<>
			{loading ? (
